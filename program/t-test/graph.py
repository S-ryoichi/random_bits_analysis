...
def plot_bar_graph(df, name):
    plt.figure()
    df.plot.bar(ylim=[0,1000])
    plt.xlabel("The number of ring oscillator circuits")
    plt.ylabel("The number of passing test")
